  ...
  return (
    <>
      <div className="lg:hidden fixed bottom-6 left-1/2 -translate-x-1/2 z-50 px-4 w-full max-w-md">
        <div className="glass border border-white/20 rounded-[28px] px-2 py-2.5 shadow-2xl shadow-black/10">
            ...
            {dockItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "flex flex-col items-center gap-1 px-4 py-2 rounded-[20px] transition-all duration-300 min-w-[70px]",
                    isActive
      ...
      <button
        ...
        className="lg:hidden fixed top-4 right-4 z-50 w-11 h-11 glass border border-white/20 rounded-full flex items-center justify-center shadow-lg shadow-black/5 active:scale-95 transition-transform"
      >
